      ...
      builder: (BuildContext context, ThemeData data, ZetaColors colors) {
        return ColoredBox(
          ...
          child: Column(
            ...
            children: [
              const ZetaText.headingLarge('Zeta Heading Large'),
              const ZetaText.headingMedium('Zeta Heading Medium'),
              const ZetaText.headingSmall('Zeta Heading Small'),
              const ZetaText.titleLarge('Zeta Title Large'),
              const ZetaText.titleMedium('Zeta Title Medium'),
              const ZetaText.titleSmall('Zeta Title Small'),
              const ZetaText.bodyLarge('Zeta Body Large'),
              const ZetaText.bodyMedium('Zeta Body Medium'),
              const ZetaText.bodySmall('Zeta Body Small'),
